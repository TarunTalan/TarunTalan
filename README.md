<h1 align="center">Hi 👋, I'm Tarun Talan</h1>
<h3 align="center">Android Developer | Competitive Programmer</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2E9EF7&center=true&vCenter=true&width=435&lines=Android+Developer;Competitive+Programmer;Clean+Architecture+Enthusiast;Always+Learning+New+Things" alt="Typing SVG" />
</p>
...
Building scalable Android applications with clean architecture. Passionate about writing efficient, maintainable code and solving complex problems through competitive programming.

- 🔭 Currently working on **VitalUp** — a health & wellness app
- 🏪 Published apps on the **Google Play Store**
- 🌐 Portfolio: [tarundev.me](https://www.tarundev.me/)
- 💡 Focus: Clean Architecture · MVVM · Jetpack Compose
...
### 🗓️ Presently — Attendance Management App
> <a href="https://github.com/TarunTalan/Presently-app"><img src="https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white" height="22"/></a>

Smart attendance tracker for college students with predictive analytics, timetable sync, Glance widgets, and Material You theming.

**Stack:** `Kotlin` `Jetpack Compose` `MVVM` `Clean Architecture` `Hilt` `Room` `WorkManager` `Firebase` `Glance Widgets`

---

### 💸 TruXpense — AI-Powered Expense Tracker
> <a href="https://github.com/TarunTalan/TruXpense-app"><img src="https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white" height="22"/></a>

Expense tracker for the Indian market with automatic bank SMS parsing across 15+ banks, fine-tuned BERT merchant classification (92% accuracy), and UPI deep-link integration.

**Stack:** `Kotlin` `Jetpack Compose` `MVVM` `Clean Architecture` `Hilt` `Room` `Retrofit` `Spring Boot` `BERT`
...
<p align="center">
  <img src="https://streak-stats.demolab.com?user=TarunTalan&theme=tokyonight&hide_border=true" height="160"/>
</p>
...
<table border="0" cellspacing="0" cellpadding="8">
  <tr>
    <td><a href="https://www.tarundev.me/" target="_blank"><img src="https://img.shields.io/badge/Portfolio-000000?style=flat&logo=vercel&logoColor=white" height="28"/></a></td>
